...
import com.babyduncan.kafkaClient.util.KafkaUtil;
 ...
 * @since: 13-4-15 16:02
 */
@Service("thriftKafkaProducer")
public class KafkaThriftProducerImpl<K, V> implements KafkaProducer<K, V> {

    private static final Logger LOG = Logger.getLogger(KafkaThriftProducerImpl.class);

    private ProducerConfig producerConfig = KafkaUtil.getThriftProducerConfig();
